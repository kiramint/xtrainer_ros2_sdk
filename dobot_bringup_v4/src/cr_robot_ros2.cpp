...
void CRRobotRos2::init()
{
    ...
    std::string serviceEnableRobot = "dobot_bringup_ros2/srv/EnableRobot";
    std::string serviceDisableRobot = "dobot_bringup_ros2/srv/DisableRobot";
    std::string serviceClearError = "dobot_bringup_ros2/srv/ClearError";
    std::string serviceSpeedFactor = "dobot_bringup_ros2/srv/SpeedFactor";
    std::string serviceUser = "dobot_bringup_ros2/srv/User";
    std::string serviceTool = "dobot_bringup_ros2/srv/Tool";
    std::string serviceRobotMode = "dobot_bringup_ros2/srv/RobotMode";
    std::string serviceSetPayload = "dobot_bringup_ros2/srv/SetPayload";
    std::string serviceDO = "dobot_bringup_ros2/srv/DO";
    std::string serviceDOInstant = "dobot_bringup_ros2/srv/DOInstant";
    std::string serviceToolDO = "dobot_bringup_ros2/srv/ToolDO";
    std::string serviceToolDOInstant = "dobot_bringup_ros2/srv/ToolDOInstant";
    std::string serviceAO = "dobot_bringup_ros2/srv/AO";
    std::string serviceAOInstant = "dobot_bringup_ros2/srv/AOInstant";
    std::string serviceAccJ = "dobot_bringup_ros2/srv/AccJ";
    std::string serviceAccL = "dobot_bringup_ros2/srv/AccL";
    std::string serviceVelJ = "dobot_bringup_ros2/srv/VelJ";
    std::string serviceVelL = "dobot_bringup_ros2/srv/VelL";
    std::string serviceCP = "dobot_bringup_ros2/srv/CP";
    std::string servicePowerOn = "dobot_bringup_ros2/srv/PowerOn";
    std::string serviceRunScript = "dobot_bringup_ros2/srv/RunScript";
    std::string serviceStop = "dobot_bringup_ros2/srv/Stop";
    std::string servicePause = "dobot_bringup_ros2/srv/Pause";
    std::string serviceContinue = "dobot_bringup_ros2/srv/Continue";

    std::string serviceEnableSafeSkin = "dobot_bringup_ros2/srv/EnableSafeSkin";
    std::string serviceSetSafeSkin = "dobot_bringup_ros2/srv/SetSafeSkin";
    std::string serviceGetStartPose = "dobot_bringup_ros2/srv/GetStartPose";
    std::string serviceStartPath = "dobot_bringup_ros2/srv/StartPatht";
    std::string servicePositiveKin = "dobot_bringup_ros2/srv/PositiveKin";
    std::string serviceInverseKin = "dobot_bringup_ros2/srv/InverseKin";
    std::string serviceGetAngle = "dobot_bringup_ros2/srv/GetAngle";
    std::string serviceGetPose = "dobot_bringup_ros2/srv/GetPose";
    std::string serviceSetCollisionLevel = "dobot_bringup_ros2/srv/SetCollisionLevel";
    std::string serviceEmergencyStop = "dobot_bringup_ros2/srv/EmergencyStop";
    std::string serviceModbusRTUCreate = "dobot_bringup_ros2/srv/ModbusRTUCreate";
    std::string serviceModbusCreate = "dobot_bringup_ros2/srv/ModbusCreate";
    std::string serviceModbusClose = "dobot_bringup_ros2/srv/ModbusClose";
    std::string serviceGetInBits = "dobot_bringup_ros2/srv/GetInBits";
    std::string serviceGetInRegs = "dobot_bringup_ros2/srv/GetInRegs";
    std::string serviceGetCoils = "dobot_bringup_ros2/srv/GetCoils";
    std::string serviceSetCoils = "dobot_bringup_ros2/srv/SetCoils";
    std::string serviceGetHoldRegs = "dobot_bringup_ros2/srv/GetHoldRegs";
    std::string serviceSetHoldRegs = "dobot_bringup_ros2/srv/SetHoldRegs";

    std::string serviceGetErrorID = "dobot_bringup_ros2/srv/GetErrorID";
    std::string serviceDI = "dobot_bringup_ros2/srv/DI";
    std::string serviceToolDI = "dobot_bringup_ros2/srv/ToolDI";
    std::string serviceAI = "dobot_bringup_ros2/srv/AI";
    std::string serviceToolAI = "dobot_bringup_ros2/srv/ToolAI";
    std::string serviceDIGroup = "dobot_bringup_ros2/srv/DIGroup";
    std::string serviceDOGroup = "dobot_bringup_ros2/srv/DoGroup";
    std::string serviceBrakeControl = "dobot_bringup_ros2/srv/BrakeControl";
    std::string serviceStartDrag = "dobot_bringup_ros2/srv/StartDrag";
    std::string serviceStopDrag = "dobot_bringup_ros2/srv/StopDrag";
    std::string serviceDragSensivity = "dobot_bringup_ros2/srv/DragSensivity";
    std::string serviceGetDO = "dobot_bringup_ros2/srv/GetDO";
    std::string serviceGetAO = "dobot_bringup_ros2/srv/GetAO";
    std::string serviceGetDOGroup = "dobot_bringup_ros2/srv/GetDOGroup";
    std::string serviceSetTool485 = "dobot_bringup_ros2/srv/SetTool485";
    std::string serviceSetSafeWallEnable = "dobot_bringup_ros2/srv/SetSafeWallEnable";
    std::string serviceSetToolPower = "dobot_bringup_ros2/srv/SetToolPower";
    std::string serviceSetToolMode = "dobot_bringup_ros2/srv/SetToolMode";
    std::string serviceSetBackDistance = "dobot_bringup_ros2/srv/SetBackDistance";
    std::string serviceSetPostCollisionMode = "dobot_bringup_ros2/srv/SetPostCollisionMode";
    std::string serviceSetUser = "dobot_bringup_ros2/srv/SetUser";
    std::string serviceSetTool = "dobot_bringup_ros2/srv/SetTool";
    std::string serviceCalcUser = "dobot_bringup_ros2/srv/CalcUser";
    std::string serviceCalcTool = "dobot_bringup_ros2/srv/CalcTool";
    std::string serviceGetInputBool = "dobot_bringup_ros2/srv/GetInputBool";
    std::string serviceGetInputInt = "dobot_bringup_ros2/srv/GetInputInt";
    std::string serviceGetInputFloat = "dobot_bringup_ros2/srv/GetInputFloat";
    std::string serviceGetOutputBool = "dobot_bringup_ros2/srv/GetOutputBool";
    std::string serviceGetOutputInt = "dobot_bringup_ros2/srv/GetOutputInt";
    std::string serviceGetOutputFloat = "dobot_bringup_ros2/srv/GetOutputFloat";
    std::string serviceSetOutputBool = "dobot_bringup_ros2/srv/SetOutputBool";
    std::string serviceSetOutputInt = "dobot_bringup_ros2/srv/SetOutputInt";
    std::string serviceSetOutputFloat = "dobot_bringup_ros2/srv/SetOutputFloat";

    std::string serviceMovJ = "dobot_bringup_ros2/srv/MovJ";
    std::string serviceMovL = "dobot_bringup_ros2/srv/MovL";
    std::string serviceMovLIO = "dobot_bringup_ros2/srv/MovLIO";
    std::string serviceMovJIO = "dobot_bringup_ros2/srv/MovJIO";
    std::string serviceArc = "dobot_bringup_ros2/srv/Arc";
    std::string serviceCircle = "dobot_bringup_ros2/srv/Circle";
    std::string serviceMoveJog = "dobot_bringup_ros2/srv/MoveJog";
    std::string serviceStopMoveJog = "dobot_bringup_ros2/srv/StopMoveJog";
    std::string serviceRelMovJTool = "dobot_bringup_ros2/srv/RelMovJTool";
    std::string serviceRelMovLTool = "dobot_bringup_ros2/srv/RelMovLTool";
    std::string serviceRelMovJUser = "dobot_bringup_ros2/srv/RelMovJUser";
    std::string serviceRelMovLUser = "dobot_bringup_ros2/srv/RelMovLUser";
    std::string serviceRelJointMovJ = "dobot_bringup_ros2/srv/RelJointMovJ";
    std::string serviceGetCurrentCommandId = "dobot_bringup_ros2/srv/GetCurrentCommandId";
    std::string serviceServoJ = "dobot_bringup_ros2/srv/ServoJ";
    std::string serviceServoP = "dobot_bringup_ros2/srv/ServoP";

    std::string serviceEnableFTSensor = "dobot_bringup_ros2/srv/EnableFTSensor";
    std::string serviceSixForceHome = "dobot_bringup_ros2/srv/SixForceHome";
    std::string serviceGetForce = "dobot_bringup_ros2/srv/GetForce";
    std::string serviceForceDriveMode = "dobot_bringup_ros2/srv/ForceDriveMode";
    std::string serviceForceDriveSpeed = "dobot_bringup_ros2/srv/ForceDriveSpeed";
    std::string serviceFCForceMode = "dobot_bringup_ros2/srv/FCForceMode";
    std::string serviceFCSetDeviation = "dobot_bringup_ros2/srv/FCSetDeviation";
    std::string serviceFCSetForceLimit = "dobot_bringup_ros2/srv/FCSetForceLimit";
    std::string serviceFCSetMass = "dobot_bringup_ros2/srv/FCSetMass";
    std::string serviceFCSetStiffness = "dobot_bringup_ros2/srv/FCSetStiffness";
    std::string serviceFCSetDamping = "dobot_bringup_ros2/srv/FCSetDamping";
    std::string serviceFCOff = "dobot_bringup_ros2/srv/FCOff";
    std::string serviceFCSetForceSpeedLimit = "dobot_bringup_ros2/srv/FCSetForceSpeedLimit";
    std::string serviceFCSetForce = "dobot_bringup_ros2/srv/FCSetForce";
    std::string serviceSetFCCollision = "dobot_bringup_ros2/srv/SetFCCollision";
    std::string serviceFCCollisionSwitch = "dobot_bringup_ros2/srv/FCCollisionSwitch";
    std::string serviceSetWorkZoneEnable = "dobot_bringup_ros2/srv/SetWorkZoneEnable";
    std::string serviceGetToolDO = "dobot_bringup_ros2/srv/GetToolDO";
    std::string serviceResetRobot = "dobot_bringup_ros2/srv/ResetRobot";
    std::string serviceRunTo = "dobot_bringup_ros2/srv/RunTo";
    std::string serviceStartRTOffset = "dobot_bringup_ros2/srv/StartRTOffset";
    std::string serviceEndRTOffset = "dobot_bringup_ros2/srv/EndRTOffset";
    std::string serviceGetError = "dobot_bringup_ros2/srv/GetError";
    std::string serviceDOGroupDEC = "dobot_bringup_ros2/srv/DOGroupDEC";
    std::string serviceGetDOGroupDEC = "dobot_bringup_ros2/srv/GetDOGroupDEC";
    std::string serviceDIGroupDEC = "dobot_bringup_ros2/srv/DIGroupDEC";
    std::string serviceRequestControl = "dobot_bringup_ros2/srv/RequestControl";
    std::string serviceCheckOddMovL = "dobot_bringup_ros2/srv/CheckOddMovL";
    std::string serviceCheckOddMovJ = "dobot_bringup_ros2/srv/CheckOddMovJ";
    std::string serviceCheckOddMovC = "dobot_bringup_ros2/srv/CheckOddMovC";
    
    std::string topicFeedInfo = "dobot_bringup_ros2/msg/FeedInfo";
...
void CRRobotRos2::getErrorID(std::vector<int> &vec)
{
    std::ignore = vec;
    // 创建服务客户端
    std::string name = "dobot_bringup_ros2/srv/GeterrorID";
